...
export const ReactTyped = memo((_a) => {
    var { style, className, typedRef, stopped, children } = _a, typedOptions = __rest(_a, ["style", "className", "typedRef", "stopped", "children"]);
    ...
    useEffect(() => {
        const typed = new Typed(rootElement.current, Object.assign({}, typedOptions));
        if (typedRef && typed) {
            typedRef(typed);
        }
        if (stopped) {
